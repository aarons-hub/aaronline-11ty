...
<section>
  <div class="container ink">
    <div class="row gap-60">
      ...
      <p>Select from the icon tiles at the left of this page.</p>
      </div>
    </div>
  </div>
</section>
<section class="projects-page ajax-projects-page" data-projects-url="{{ '/data/projects.json' | url }}" data-asset-prefix="{{ '/' | url }}" aria-live="polite">
